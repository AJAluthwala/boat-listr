...
export async function sendMail(
	...
	if (!transporter) {
		...
		console.log("[mail:dev]", { to, subject, body, replyTo: options.replyTo });
...
<body style="margin:0;padding:0;background:#f4f8f8;font-family:Arial,Helvetica,sans-serif;color:#0a3d62;">
  <div style="max-width:520px;margin:32px auto;background:#ffffff;border:1px solid #e1eef5;border-radius:18px;overflow:hidden;">
    <div style="background-color:#0a3d62;background-image:linear-gradient(135deg,#051d35 0%,#0a3d62 40%,#1883ff 100%);padding:28px;text-align:center;">
      <div style="font-size:22px;font-weight:800;color:#ffffff;letter-spacing:-0.02em;">
        Boat<span style="color:#86c5ff;">L</span>istr
      </div>
    </div>
